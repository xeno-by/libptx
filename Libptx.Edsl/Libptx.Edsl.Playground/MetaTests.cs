...
namespace Libptx.Edsl.Playground
{
    [TestFixture]
    public class MetaTests
    {
        ...
        public void EnsureMostStuffIsMarkedWithDebuggerNonUserCode()
        {
            ...
            if (asm == null) asm = AppDomain.CurrentDomain.Load("Libptx.Edsl");
            ...
            {
                Log.WriteLine(String.Format("{0} types in Libptx.Edsl aren't marked with [DebuggerNonUserCode]:", failed_types.Count()));
