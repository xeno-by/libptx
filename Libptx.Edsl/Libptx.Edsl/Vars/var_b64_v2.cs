...
namespace Libptx.Edsl.Vars
{
    public class var_b64_v2 : var
    {
        ...
        public new var_b64_v2 reg { get { return Clone(v => v.Space = space.reg); } }
        public new var_b64_v2 sreg { get { return Clone(v => v.Space = space.sreg); } }
        public new var_b64_v2 local { get { return Clone(v => v.Space = space.local); } }
        public new var_b64_v2 shared { get { return Clone(v => v.Space = space.shared); } }
        public new var_b64_v2 global { get { return Clone(v => v.Space = space.global); } }
        public new var_b64_v2 param { get { return Clone(v => v.Space = space.param); } }
        public new var_b64_v2 const0 { get { return Clone(v => v.Space = space.const0); } }
        public new var_b64_v2 const1 { get { return Clone(v => v.Space = space.const1); } }
        public new var_b64_v2 const2 { get { return Clone(v => v.Space = space.const2); } }
        public new var_b64_v2 const3 { get { return Clone(v => v.Space = space.const3); } }
        public new var_b64_v2 const4 { get { return Clone(v => v.Space = space.const4); } }
        public new var_b64_v2 const5 { get { return Clone(v => v.Space = space.const5); } }
        public new var_b64_v2 const6 { get { return Clone(v => v.Space = space.const6); } }
        public new var_b64_v2 const7 { get { return Clone(v => v.Space = space.const7); } }
        public new var_b64_v2 const8 { get { return Clone(v => v.Space = space.const8); } }
        public new var_b64_v2 const9 { get { return Clone(v => v.Space = space.const9); } }
        public new var_b64_v2 const10 { get { return Clone(v => v.Space = space.const10); } }
        ...
        internal var_b64_v2 Clone(params Action<var_b64_v2>[] mods)
        {
