...
namespace Libptx
{
    ...
    public class Entry : Atom
    {
        ...
        public virtual Module Module { get { return _module; } }
        public Entry(Module module) { _module = module; }
        ...
        protected override void RenderAsPtx(TextWriter writer)
        {
            ...
            if (Module.Version >= SoftwareIsa.PTX_14)
            {
            ...
            foreach (var unsafe_stmt in Stmts)
            {
                ...
                if (op != null) op.Operands.ForEach(arg =>
                {
                    ...
                    extract_vars = e =>
                    {
                        ...
                        if (e_var != null)
                        {
                            var new_style_param = e_var.Space == param && Module.Version >= SoftwareIsa.PTX_14;
                        ...
                        var e_addr = e as Address;
                        if (e_addr != null)
                        {
                            extract_vars(e_addr.Base);
                            extract_vars(e_addr.Offset == null ? null : e_addr.Offset.Base);
                        }
                    };
