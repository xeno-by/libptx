...
namespace Libptx.Reflection
{
    ...
    {
        public static SoftwareIsa CoreVersion(this Atom atom)
        {
            if (atom == null) return 0;
            var t_swisa = atom.Version();
        ...
        public static HardwareIsa CoreTarget(this Atom atom)
        {
            if (atom == null) return 0;
            var t_hwisa = atom.Target();
