...
namespace Libptx.Edsl.Types
{
    public class b8 : type
    {
        ...
        public static var_b8 reg { get { return new var_b8().Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public static var_b8 sreg { get { return new var_b8().Clone(v => v.Space = Common.Enumerations.space.sreg); } }
