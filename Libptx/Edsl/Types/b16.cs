...
namespace Libptx.Edsl.Types
{
    public class b16 : type
    {
        ...
        public static var_b16 reg { get { return new var_b16().Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public static var_b16 sreg { get { return new var_b16().Clone(v => v.Space = Common.Enumerations.space.sreg); } }
