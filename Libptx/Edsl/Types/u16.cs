...
namespace Libptx.Edsl.Types
{
    public class u16 : type
    {
        ...
        public static var_u16 reg { get { return new var_u16().Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public static var_u16 sreg { get { return new var_u16().Clone(v => v.Space = Common.Enumerations.space.sreg); } }
