...
namespace Libptx.Edsl.Types
{
    public class u64 : type
    {
        ...
        public static var_u64 reg { get { return new var_u64().Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public static var_u64 sreg { get { return new var_u64().Clone(v => v.Space = Common.Enumerations.space.sreg); } }
