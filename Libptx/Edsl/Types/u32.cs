...
namespace Libptx.Edsl.Types
{
    public class u32 : type
    {
        ...
        public static var_u32 reg { get { return new var_u32().Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public static var_u32 sreg { get { return new var_u32().Clone(v => v.Space = Common.Enumerations.space.sreg); } }
