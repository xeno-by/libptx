...
namespace Libptx.Edsl.Types
{
    public class f32 : type
    {
        ...
        public static var_f32 reg { get { return new var_f32().Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public static var_f32 sreg { get { return new var_f32().Clone(v => v.Space = Common.Enumerations.space.sreg); } }
