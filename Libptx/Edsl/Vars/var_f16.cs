...
namespace Libptx.Edsl.Vars
{
    public class var_f16 : has_type_f16
    {
        ...
        public new var_f16 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_f16 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
