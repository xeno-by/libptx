...
namespace Libptx.Edsl.Vars
{
    public class var_pred : has_type_pred
    {
        ...
        public new var_pred reg { get { return Clone(v => v.Space = space.reg); } }
        public new var_pred sreg { get { return Clone(v => v.Space = space.sreg); } }
        public new var_pred local { get { return Clone(v => v.Space = space.local); } }
        public new var_pred shared { get { return Clone(v => v.Space = space.shared); } }
        public new var_pred global { get { return Clone(v => v.Space = space.global); } }
        public new var_pred param { get { return Clone(v => v.Space = space.param); } }
        public new var_pred const0 { get { return Clone(v => v.Space = space.const0); } }
        public new var_pred const1 { get { return Clone(v => v.Space = space.const1); } }
        public new var_pred const2 { get { return Clone(v => v.Space = space.const2); } }
        public new var_pred const3 { get { return Clone(v => v.Space = space.const3); } }
        public new var_pred const4 { get { return Clone(v => v.Space = space.const4); } }
        public new var_pred const5 { get { return Clone(v => v.Space = space.const5); } }
        public new var_pred const6 { get { return Clone(v => v.Space = space.const6); } }
        public new var_pred const7 { get { return Clone(v => v.Space = space.const7); } }
        public new var_pred const8 { get { return Clone(v => v.Space = space.const8); } }
        public new var_pred const9 { get { return Clone(v => v.Space = space.const9); } }
        public new var_pred const10 { get { return Clone(v => v.Space = space.const10); } }
