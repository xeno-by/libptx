...
namespace Libptx.Edsl.Vars
{
    public class var_s16_v4 : var
    {
        ...
        public new var_s16_v4 reg { get { return Clone(v => v.Space = space.reg); } }
        public new var_s16_v4 sreg { get { return Clone(v => v.Space = space.sreg); } }
        public new var_s16_v4 local { get { return Clone(v => v.Space = space.local); } }
        public new var_s16_v4 shared { get { return Clone(v => v.Space = space.shared); } }
        public new var_s16_v4 global { get { return Clone(v => v.Space = space.global); } }
        public new var_s16_v4 param { get { return Clone(v => v.Space = space.param); } }
        public new var_s16_v4 const0 { get { return Clone(v => v.Space = space.const0); } }
        public new var_s16_v4 const1 { get { return Clone(v => v.Space = space.const1); } }
        public new var_s16_v4 const2 { get { return Clone(v => v.Space = space.const2); } }
        public new var_s16_v4 const3 { get { return Clone(v => v.Space = space.const3); } }
        public new var_s16_v4 const4 { get { return Clone(v => v.Space = space.const4); } }
        public new var_s16_v4 const5 { get { return Clone(v => v.Space = space.const5); } }
        public new var_s16_v4 const6 { get { return Clone(v => v.Space = space.const6); } }
        public new var_s16_v4 const7 { get { return Clone(v => v.Space = space.const7); } }
        public new var_s16_v4 const8 { get { return Clone(v => v.Space = space.const8); } }
        public new var_s16_v4 const9 { get { return Clone(v => v.Space = space.const9); } }
        public new var_s16_v4 const10 { get { return Clone(v => v.Space = space.const10); } }
        ...
        internal var_s16_v4 Clone(params Action<var_s16_v4>[] mods)
        {
