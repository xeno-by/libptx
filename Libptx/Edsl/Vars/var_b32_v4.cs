...
namespace Libptx.Edsl.Vars
{
    public class var_b32_v4 : var
    {
        ...
        public var_b32 z { get { return Clone<var_b32>(v => v.Type = v.Type.z, v => v.Init = null); } }
        ...
        public new var_b32_v4 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.Special); } }
        ...
        public new var_b32_v4 @const { get { return Clone(v => v.Space = Common.Enumerations.space.Const); } }
        ...
        public var_b32_v4 align16{ get { return align(16); } }
        public var_b32_v4 align32{ get { return align(32); } }
        public var_b32_v4 align64{ get { return align(64); } }
        public var_b32_v4 align128{ get { return align(128); } }

        public var_b32_v4 export { get { return Clone(v => v.IsVisible = true); } }
        public var_b32_v4 import { get { return Clone(v => v.IsExtern = true); } }
        public var_b32_v4 @extern { get { return Clone(v => v.IsExtern = true); } }

        internal var_b32_v4 Clone()
        {
            return Clone<var_b32_v4>();
        }
        ...
        internal var_b32_v4 Clone(params Action<var_b32_v4>[] mods)
        {
            return Clone<var_b32_v4>(mods);
        }
