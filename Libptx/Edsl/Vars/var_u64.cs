...
namespace Libptx.Edsl.Vars
{
    public class var_u64 : has_type_u64
    {
        ...
        public new var_u64 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_u64 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
