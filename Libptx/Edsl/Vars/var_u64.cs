...
namespace Libptx.Edsl.Vars
{
    public class var_u64 : has_type_u64
    {
        ...
        public new var_u64 reg { get { return Clone(v => v.Space = space.reg); } }
        public new var_u64 sreg { get { return Clone(v => v.Space = space.sreg); } }
        public new var_u64 local { get { return Clone(v => v.Space = space.local); } }
        public new var_u64 shared { get { return Clone(v => v.Space = space.shared); } }
        public new var_u64 global { get { return Clone(v => v.Space = space.global); } }
        public new var_u64 param { get { return Clone(v => v.Space = space.param); } }
        public new var_u64 const0 { get { return Clone(v => v.Space = space.const0); } }
        public new var_u64 const1 { get { return Clone(v => v.Space = space.const1); } }
        public new var_u64 const2 { get { return Clone(v => v.Space = space.const2); } }
        public new var_u64 const3 { get { return Clone(v => v.Space = space.const3); } }
        public new var_u64 const4 { get { return Clone(v => v.Space = space.const4); } }
        public new var_u64 const5 { get { return Clone(v => v.Space = space.const5); } }
        public new var_u64 const6 { get { return Clone(v => v.Space = space.const6); } }
        public new var_u64 const7 { get { return Clone(v => v.Space = space.const7); } }
        public new var_u64 const8 { get { return Clone(v => v.Space = space.const8); } }
        public new var_u64 const9 { get { return Clone(v => v.Space = space.const9); } }
        public new var_u64 const10 { get { return Clone(v => v.Space = space.const10); } }
        ...
        internal var_u64 Clone(params Action<var_u64>[] mods)
        {
