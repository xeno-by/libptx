...
namespace Libptx.Edsl.Vars
{
    public class var_b8 : has_type_b8
    {
        ...
        public new var_b8 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_b8 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
