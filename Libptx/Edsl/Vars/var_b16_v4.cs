...
namespace Libptx.Edsl.Vars
{
    public class var_b16_v4 : var
    {
        ...
        public new var_b16_v4 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_b16_v4 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
