...
namespace Libptx.Edsl.Vars
{
    public class var_b64 : has_type_b64
    {
        ...
        public new var_b64 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_b64 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
