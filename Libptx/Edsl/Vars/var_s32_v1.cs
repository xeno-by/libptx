...
{
    public class var_s32_v1 : var
    {
        public var_s32_v1_a1 this[int dim] { get { return Clone<var_s32_v1_a1>(v => v.Type = v.Type[dim], v => v.Init = null); } }

        public new var_s32_v1 reg { get { return Clone(v => v.Space = Common.Enumerations.Space.Register); } }
        public new var_s32_v1 sreg { get { return Clone(v => v.Space = Common.Enumerations.Space.Special); } }
        ...
        public new var_s32_v1 @const { get { return Clone(v => v.Space = Common.Enumerations.Space.Const); } }
        ...
        public var_s32_v1() { Alignment = 4 /* sizeof(int1) */; }
        public var_s32_v1 align(int alignment){ return Clone(v => v.Alignment = alignment.AssertThat(a => a.Unfoldi(i => i / 2, i => i > 1).All(mod => mod == 0))); }
        public var_s32_v1 align4{ get { return align(4); } }
        public var_s32_v1 align8{ get { return align(8); } }
        public var_s32_v1 align16{ get { return align(16); } }
        public var_s32_v1 align32{ get { return align(32); } }

        public var_s32_v1 export { get { return Clone(v => v.IsVisible = true); } }
        public var_s32_v1 import { get { return Clone(v => v.IsExtern = true); } }
        public var_s32_v1 @extern { get { return Clone(v => v.IsExtern = true); } }

        private var_s32_v1 Clone()
        {
            return Clone<var_s32_v1>();
        }
        ...
        protected var_s32_v1 Clone(params Action<var_s32_v1>[] mods)
        {
            return Clone<var_s32_v1>(mods);
        }
