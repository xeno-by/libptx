...
namespace Libptx.Edsl.Vars
{
    public class var_u8 : has_type_u8
    {
        ...
        public new var_u8 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_u8 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
