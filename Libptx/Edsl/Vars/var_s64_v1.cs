...
namespace Libptx.Edsl.Vars
{
    public class var_s64_v1 : var
    {
        ...
        public new var_s64_v1 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_s64_v1 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
