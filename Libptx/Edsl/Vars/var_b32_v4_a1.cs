...
namespace Libptx.Edsl.Vars
{
    ...
    {
        public new var_b32_v4_a1 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_b32_v4_a1 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
