...
namespace Libptx.Edsl.Vars
{
    ...
    {
        public new var_surf reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_surf sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
