...
namespace Libptx.Edsl.Vars
{
    public class var_b16 : has_type_b16
    {
        ...
        public new var_b16 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_b16 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
