...
namespace Libptx.Edsl.Vars
{
    public class var_s64 : has_type_s64
    {
        ...
        public new var_s64 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_s64 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
