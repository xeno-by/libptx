...
namespace Libptx.Edsl.Vars
{
    public class var_u32 : has_type_u32
    {
        ...
        public new var_u32 sreg { get { return Clone(v => v.Space = Common.Enumerations.Space.Special); } }
        ...
        public new var_u32 @const { get { return Clone(v => v.Space = Common.Enumerations.Space.Const); } }
