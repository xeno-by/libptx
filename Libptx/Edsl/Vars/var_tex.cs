...
namespace Libptx.Edsl.Vars
{
    ...
    {
        public new var_tex reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_tex sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
