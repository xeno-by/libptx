...
namespace Libptx.Edsl.Vars
{
    public class var_u16 : has_type_u16
    {
        ...
        public new var_u16 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_u16 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
