...
namespace Libptx.Edsl.Vars
{
    public class var_s16 : has_type_s16
    {
        ...
        public new var_s16 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_s16 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
