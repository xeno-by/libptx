...
namespace Libptx.Edsl.Vars
{
    public class var_u64_v4 : var
    {
        ...
        public new var_u64_v4 reg { get { return Clone(v => v.Space = Common.Enumerations.Space.Register); } }
        public new var_u64_v4 sreg { get { return Clone(v => v.Space = Common.Enumerations.Space.Special); } }
        ...
        public new var_u64_v4 @const { get { return Clone(v => v.Space = Common.Enumerations.Space.Const); } }
        ...
        protected var_u64_v4 Clone(params Action<var_u64_v4>[] mods)
        {
