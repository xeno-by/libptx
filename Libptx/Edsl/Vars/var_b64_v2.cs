...
namespace Libptx.Edsl.Vars
{
    public class var_b64_v2 : var
    {
        ...
        public new var_b64_v2 reg { get { return Clone(v => v.Space = Common.Enumerations.space.reg); } }
        public new var_b64_v2 sreg { get { return Clone(v => v.Space = Common.Enumerations.space.sreg); } }
